...
silent only
silent tabonly
cd /d/Repo/nand2tetris/projects/05
...
edit Memory.hdl
argglobal
if bufexists(fnamemodify("Memory.hdl", ":p")) | buffer Memory.hdl | else | edit Memory.hdl | endif
balt Computer.hdl
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
argglobal
1argu
if bufexists(fnamemodify("Memory.tst", ":p")) | buffer Memory.tst | else | edit Memory.tst | endif
balt CPU.hdl
setlocal keymap=
setlocal noarabic
setlocal autoindent
